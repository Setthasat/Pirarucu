    ...
    <section className="relative h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 text-center px-4 max-w-2xl mx-auto">
        ...
        <div className="mt-6 flex justify-center items-center gap-6">
          <a className="bg-[#5EEAD4] w-[40%] text-white font-bold py-3 px-4 rounded flex justify-center items-center  gap-2">
            <Play /> Watch Documentary
          </a>
          <a href="#feature" className="w-[30%] text-white border font-bold py-3 px-4 rounded cursor-pointer hover:text-[#5EEAD4] hover:border-[#5EEAD4]">
            Explore Facts
          </a>
        </div>
      </div>
